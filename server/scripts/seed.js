...
const notices = [
  {
    title: '2026년 5월 정기 회의 안내', category: '공지', author: 'CLASS FC 운영진',
    pinned: true, important: true, daysAgo: 2,
    content: `안녕하세요, CLASS FC 운영진입니다.\n\n5월 정기 회의를 아래와 같이 진행합니다.\n\n일시: 2026년 5월 26일 (화) 오후 7시\n장소: 소프트웨어학과 세미나실 (공학관 5층)\n\n논의 안건:\n1. 5월 경기 리뷰\n2. 6월 컵 대회 일정 확정\n3. 신입 부원 환영회 일정\n4. 유니폼 추가 제작 건\n\n필참 부탁드립니다.`
  },
  {
    title: '5/24 EE United 전 라인업 안내', category: '경기', author: '차형창',
    pinned: true, important: false, daysAgo: 1,
    content: `5월 24일 EE United 와의 리그 경기 라인업입니다.\n\n선발 11인:\nGK 박지훈 / DF 윤성호 김태효 오재현 / MF 이성준 정민혁 서동훈 / FW 한승우 차형창 강재민 / 신현우\n\n집결: 14:00 학생회관 운동장 앞\n워밍업: 14:20 부터\n킥오프: 15:00`
  },
  {
    title: '신입 부원 모집 (~5/31까지)', category: '모집', author: '김태효',
    pinned: false, important: false, daysAgo: 6,
    content: `CLASS FC 신입 부원을 모집합니다.\n\n자격: 소프트웨어학과 재학생 (학년 무관)\n인원: 4명 내외\n지원: 운영진에게 DM 또는 이메일`
  },
  {
    title: '5/17 CHEM Lions 전 승리 후기 3-1', category: '경기', author: '이성준',
    pinned: false, important: false, daysAgo: 4,
    content: `오늘 경기 다들 수고 많으셨습니다.\n\n전반 차형창 선수 선제골 이후 후반에 한승우, 강재민 선수의 추가골로 3-1 승리했습니다.`
  },
  {
    title: '유니폼 사이즈 재조사', category: '운영', author: 'CLASS FC 운영진',
    pinned: false, important: false, daysAgo: 9,
    content: `상반기 유니폼 추가 제작을 위해 사이즈를 다시 조사합니다.\n\n신청 폼에 본인 이름, 등번호, 사이즈, 마킹 영문을 기입해 주세요.\n마감: 5/22 (목) 자정`
  },
  {
    title: '동아리 회비 납부 안내 (2026 상반기)', category: '운영', author: '김태효',
    pinned: false, important: true, daysAgo: 16,
    content: `2026년 상반기 동아리 회비 납부 안내입니다.\n\n금액: 30,000원\n계좌: 농협 1234-5678-9012 (CLASS FC)\n마감: 5/20`
  }
];

const gallery = [
  { title: 'vs CHEM Lions 승리 직후', tag: 'Match',     gradient: 'linear-gradient(135deg, #00d166 0%, #112940 100%)', icon: 'trophy',   date: '2026-05-17' },
  { title: '단체 사진 - 시즌 개막',   tag: 'Team',      gradient: 'linear-gradient(135deg, #4a90e2 0%, #050b18 100%)', icon: 'team',     date: '2026-03-15' },
  { title: '주장 차형창의 해트트릭',  tag: 'Highlight', gradient: 'linear-gradient(135deg, #ff4d5e 0%, #112940 100%)', icon: 'star',     date: '2026-04-26' },
  { title: '훈련 - 패스 연습',         tag: 'Training',  gradient: 'linear-gradient(135deg, #f5a623 0%, #050b18 100%)', icon: 'training', date: '2026-05-08' },
  { title: '신입 부원 환영회',         tag: 'Event',     gradient: 'linear-gradient(135deg, #00d166 0%, #4a90e2 100%)', icon: 'event',    date: '2026-03-22' },
  { title: '경기장으로',               tag: 'Match',     gradient: 'linear-gradient(135deg, #112940 0%, #00d166 100%)', icon: 'field',    date: '2026-05-10' },
  { title: '동아리 체육대회',          tag: 'Event',     gradient: 'linear-gradient(135deg, #4a90e2 0%, #00d166 100%)', icon: 'event',    date: '2026-04-12' },
  { title: '베스트 일레븐 발표',       tag: 'Highlight', gradient: 'linear-gradient(135deg, #f5a623 0%, #ff4d5e 100%)', icon: 'star',     date: '2026-05-19' },
  { title: '워밍업',                   tag: 'Training',  gradient: 'linear-gradient(135deg, #050b18 0%, #4a90e2 100%)', icon: 'training', date: '2026-05-03' },
  { title: '시즌 첫 골',               tag: 'Highlight', gradient: 'linear-gradient(135deg, #00d166 0%, #f5a623 100%)', icon: 'star',     date: '2026-03-29' },
  { title: '응원 온 팬들',             tag: 'Event',     gradient: 'linear-gradient(135deg, #ff4d5e 0%, #f5a623 100%)', icon: 'event',    date: '2026-04-19' },
  { title: '팀 미팅',                  tag: 'Team',      gradient: 'linear-gradient(135deg, #112940 0%, #4a90e2 100%)', icon: 'team',     date: '2026-04-05' }
];
